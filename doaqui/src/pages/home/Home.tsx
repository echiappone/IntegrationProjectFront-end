...
function Home() {
    return (
        <>
            <Grid container direction="row" justifyContent="center" alignItems="center" style={{ backgroundColor: "#05C19C" }}>
                <Grid alignItems="center" item xs={6}>
                    ...
                    <Box display="flex" justifyContent="center">
                        ...
                        <Button variant="outlined" style={{ borderColor: "white", backgroundColor: "#E67E22", color: "white" }}>Doa aqui</Button>
                    </Box>
                </Grid>
                <Grid item xs={6} >
